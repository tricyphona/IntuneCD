...
from src.IntuneCD.backup.Intune.AppProtection import AppProtectionBackupModule
from src.IntuneCD.intunecdlib.GraphModule import GraphModule


class TestAppProtectionBackupModule(unittest.TestCase):
    """Tests for the AppProtectionBackupModule class."""

    def setUp(self):
        self.module = AppProtectionBackupModule()
    ...
    @patch.object(GraphModule, "make_graph_request")
    @patch.object(AppProtectionBackupModule, "log")
